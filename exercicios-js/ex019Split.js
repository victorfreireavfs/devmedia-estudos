// let paises_length = 'Brasil-França-Alemanha-Argentina-Canadá-México';

// let paises_array = paises_length.split("-");
...
// let nome = "Antônio Victor Freire da Silva";

// let nome_array = nome.split(" ");

// let primeiro_nome = nome_array[0];

// console.log(`Olá, ${primeiro_nome}! Seja bem vindo ao clube dos canalhas. `)
...
let titulo = "=== chuva de meteóros  -   hemisfério sul ===";
console.log(titulo.toUpperCase());
console.log("\n");


for( let chuva of chuvas_meteoros){
